...
<div class="col-md-2">
	...
	<div class="col-md-3">
		<label>Nombre</label>
		<select name="adquisicion" id="adq" class="form-control">
			<option value="">--Seleccione--</option>
...
<div class="col-md-2">
		...
		<input type="text" id="idrub" class="form-control">
	</div>
	<div class="col-md-3">
		<label>Rubro</label>
		<select name="rubro" id="rubdesc" class="form-control">
			<option value="">--Seleccione--</option>
				@foreach ($rubro as $rubdesc)	
					<option value="{{$rubdesc->DescRub }}">{{ $rubdesc->IdRub." -- ".$rubdesc->DescRub }}</option>
				@endforeach
		</select>
	</div>
	<div class="col-md-2">
...
<div class="row">
	<div class="col-md-4">.¿El bien está actualmente localizado Físicamente?
